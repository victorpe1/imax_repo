...
import com.imax.app.ui.supervisor.RegistroListadoDocumentos;
...
public class RegistroSupervisorFotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new RegistroSupervisorFotoActivity.async_sincronizacion().execute();
        ...
        progressDialog = new ProgressDialog(RegistroSupervisorFotoActivity.this);
            ...
            public void afterTextChanged(Editable s) {
                if (s.toString().trim().isEmpty()) {
                    editText.setBackground(
                            ContextCompat.getDrawable(RegistroSupervisorFotoActivity.this,
        ...
        switch (id) {
            case R.id.menu_pedido_siguiente:
                ...
                if (validarCampos()) {
                    ...
                    Intent intent = new Intent(RegistroSupervisorFotoActivity.this,
                            RegistroFotoEvidenciaActivity.class);
    ...
    class async_sincronizacion extends AsyncTask<Void, String, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                ...
                if (Util.isConnectingToRed(RegistroSupervisorFotoActivity.this)) {
                    ...
                    response = XMSApi.getApiEasyfact(RegistroSupervisorFotoActivity.this.getApplicationContext())
        ...
        protected void onPostExecute(String result) {
            ...
            switch (result) {
                ...
                case Constants.FAIL_CONNECTION:
                    Toast.makeText(RegistroSupervisorFotoActivity.this, R.string.error_no_autorizado, Toast.LENGTH_SHORT).show();
                    break;
                default:
                    MyDetailDialog myDetailDialog = new MyDetailDialog(RegistroSupervisorFotoActivity.this,
