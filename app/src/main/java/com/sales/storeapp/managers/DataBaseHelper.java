    ...
    public void actualizar_byh_xms_client(JSONArray jArray) {
        ...
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                cv.put(idCliente, jsonData.getInt("idCliente"));
                ...
                cv.put(idDistrito, jsonData.getInt("idDistrito"));
                cv.put(local, jsonData.getInt("local"));
                ...
                cv.put(idTienda, jsonData.getInt("idTienda"));
                cv.put(idVendedor, jsonData.getInt("idVendedor"));
                cv.put(idCobrador, jsonData.getInt("idCobrador"));
                cv.put(activo, jsonData.getInt("activo"));
                ...
                cv.put(idDistritoDirecc1, jsonData.getInt("idDistritoDirecc1"));
                cv.put(idDistritoDirecc2, jsonData.getInt("idDistritoDirecc2"));
                cv.put(idDistritoDirecc3, jsonData.getInt("idDistritoDirecc3"));
                cv.put(idDistritoDirecc4, jsonData.getInt("idDistritoDirecc4"));
